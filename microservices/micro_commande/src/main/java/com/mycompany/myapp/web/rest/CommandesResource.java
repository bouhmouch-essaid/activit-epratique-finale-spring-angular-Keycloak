...
public class CommandesResource {
    ...
    private static final String ENTITY_NAME = "microCommandeCommandes";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<CommandesDTO>> getAllCommandes(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Commandes");
        Page<CommandesDTO> page = commandesService.findAll(pageable);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<CommandesDTO> getCommandes(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCommandes(@PathVariable("id") String id) {
