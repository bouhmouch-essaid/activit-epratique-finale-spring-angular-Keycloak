...
@AnalyzeClasses(packagesOf = MicroCommandeApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(MicroCommandeApp.class), alwaysTrue())
